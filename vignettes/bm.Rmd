...
```{r, out.width = "600px", fig.align="center", echo = FALSE, fig.cap=c("Modality-specific clustering structure")}
...
```{r, out.width = "600px", fig.align="center", echo = FALSE, fig.cap=c("Common, RNA distinct, and ADT distinct embeddings")}
...
```{r, out.width = "600px", fig.align="center", echo = FALSE, fig.cap=c("Gene alignment plots, for all genes, or highlight the marker genes for B cells, CD14 Monocytes, or cell cycling")}
