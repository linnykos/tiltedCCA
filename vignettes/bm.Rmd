...
```{r, out.width = "650px", fig.align="center", echo = FALSE, fig.cap=c("UMAPs of the RNA modality (left), ADT modality (middle), or WNN (right, which combines the information in the RNA and ADT)")}
